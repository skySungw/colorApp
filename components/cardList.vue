<template>
	<view class="cu-card case no-card">
		...
		<!-- 第三种结束 -->
		<!-- 第一种类型 -->
		<view class="cu-item shadow margin-tb-sm">
			<view class="image">
					...
					<view class="content flex-sub">
						...
						<view class="text-gray text-sm flex justify-between">
							...
							<view class="text-gray text-sm">
								...
								<text @click="onClickZan">
									<text class="cuIcon-appreciatefill margin-lr-xs text-blue"></text> 20
								</text>
								<text @click="onClickFavor">
									<text class="cuIcon-favorfill margin-lr-xs text-orange"></text> 5
								</text>
								<text @click="onClickMessage">
		...
		<view class="cu-card dynamic no-card margin-tb-sm">
		  <view class="cu-item shadow">
		    ...
		    <view class="grid flex-sub padding-lr col-3 grid-square">
		      <view class="bg-img" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg);" v-for="(item, index) in [1,2,3,4,5,6,7,8,9]" :key="index">
		      </view>
		    </view>
